# -*- coding: utf-8 -*-
"""svm_poly_different_test_size.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1e-SvLCo6_m3Tm3nx4Cx8-ELVtYTYUxz8
"""
...
# the accuracy can be over 0.95 even though the training data are only 10% (testing data are 90%)

# however
# the accuracy do not significantly increase when the the amount of the training data increase
# one of reason is that the accuracy (0.95) are already quite high when the test size is 90% 
