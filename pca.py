...
Original file is located at
    https://colab.research.google.com/drive/1mkVbwD2mRbaU1t8xYfW8YsONLKuHR1LX
"""
...
# the graph show that in two dimentional diagram, 
# the points with the same colors are not concentrated, 
# some points with different color are close to each other
# this reflect that the variation under  the two dimentions is quite low
# it is hard to classify

# higher dimentions are required
# from the above calculation,
# To achieve 95.0 % variance,
# The number of component should not be decreased under 150 by using the pca method.

# please note that the above result may change when some parameters are reset or specified
# this should refer to the relavent document
